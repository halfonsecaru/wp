import { $a as ɵɵdefineNgModule, $n as Renderer2, As as ɵɵstyleProp, Bi as setClassMetadata, Bn as NgModule, Ci as performanceMarkFeature, Dc as RuntimeError, Dn as Injectable, En as Inject, Gn as Optional, Hr as createNgModule, Mn as LOCALE_ID, Nn as LocaleDataIndex, Nt as untracked, O as booleanAttribute, On as Input, Oo as ɵɵinjectAttribute, Q as numberAttribute, Qa as ɵɵdefineDirective, Rc as formatRuntimeError, Sn as IMAGE_CONFIG_DEFAULTS, Uc as inject, Ut as ApplicationRef, Wn as NgModuleRef$1, Wt as Attribute, Yi as unwrapSafeValue, Yn as Pipe, _n as Host, aa as ɵɵNgOnChangesFeature, ai as getLocalePluralCase$1, al as ɵɵdefineInjector, br as ViewContainerRef, cl as ɵɵinject, dc as INTERNAL_APPLICATION_ERROR_HANDLER, eo as ɵɵdefinePipe, fc as InjectionToken, fr as TemplateRef, gn as ElementRef, hi as isSubscribable, ii as getLocaleCurrencyCode$1, il as ɵɵdefineInjectable, in as DEFAULT_CURRENCY_CODE, ji as registerLocaleData$1, kc as Version, m as KeyValueDiffers, mi as isSignal, mn as Directive, nc as DOCUMENT, p as IterableDiffers, pc as Injector, pi as isPromise, qr as findLocaleData, r as ChangeDetectorRef, rc as DestroyRef, tl as stringify, to as ɵɵdirectiveInject, tr as RendererStyleFlags2, xc as NgZone, xn as IMAGE_CONFIG, yl as Subject, yo as ɵɵgetInheritedFactory } from "./core-lutpOAv_.js";
...
var Location = class Location {
	...
	constructor(locationStrategy) {
		...
		this._basePath = _stripOrigin(stripTrailingSlash(_stripIndexHtml(this._locationStrategy.getBaseHref())));
...
var I18nSelectPipe = class I18nSelectPipe {
	transform(value, mapping) {
		...
		if (mapping.hasOwnProperty("other")) return mapping["other"];
		return "";
	}
...
var INTERNAL_PRECONNECT_CHECK_BLOCKLIST = new Set([
	"localhost",
	"127.0.0.1",
	"0.0.0.0",
	"[::1]"
...
var NgOptimizedImage = class NgOptimizedImage {
	...
	generatePlaceholder(placeholderInput) {
		...
		if (placeholderInput === true) return `url(${this.callImageLoader({
			src: this.ngSrc,
			width: placeholderResolution,
			isPlaceholder: true
		})})`;
		else if (typeof placeholderInput === "string") return `url(${placeholderInput})`;
		return null;
	}
...
//# sourceMappingURL=common-DJGEzqpQ.js.map