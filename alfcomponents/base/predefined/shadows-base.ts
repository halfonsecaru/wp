import { AlfColorEnum, AlfShadowEnum, AlfTextShadowEnum } from '@alfcomponents/enums';
import { AlfShadowsBaseInterface } from '@alfcomponents/interfaces';

/**
 * Configuración base para sombras (Shadows).
