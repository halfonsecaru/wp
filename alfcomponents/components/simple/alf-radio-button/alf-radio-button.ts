...
export class AlfRadioButton extends AlfBaseDirectives {
  ...
  public readonly radioButtonStyle = input<AlfRadioButtonVariantEnum>(AlfRadioButtonVariantEnum.Elegant);
  ...
  protected readonly labelComputed = computed<string | null>(() => {
    // Prefer explicit label input; internal CVA label is only a fallback.
