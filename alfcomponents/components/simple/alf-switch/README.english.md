...
High-performance standalone switch/toggle component designed for Angular 21. Fully integrated with the **Elite Visual Engine** and optimized for Zoneless architectures using native Signals.
