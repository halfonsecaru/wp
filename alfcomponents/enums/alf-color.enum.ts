...
export enum AlfColorEnum {
  ...
  GradientWarningTextDisabled = 'var(--alf-gradient-warning-text-disabled, #ffffffff)',
  GradientWarningTextActive = 'var(--alf-gradient-warning-text-active, #ffffffff)',
  GradientWarningTextHover = 'var(--alf-gradient-warning-text-hover, #ffffffff)',
  ...
  GradientInfoTextDisabled = 'var(--alf-gradient-info-text-disabled, #ffffffff)',
  GradientInfoTextActive = 'var(--alf-gradient-info-text-active, #ffffffff)',
  GradientInfoTextHover = 'var(--alf-gradient-info-text-hover, #ffffffff)',
