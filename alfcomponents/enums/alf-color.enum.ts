...
export enum AlfColorEnum {
  ...
  WarningGhostText = 'var(--alf-warning-ghost-text, #ffc107)',
  ...
  InfoGhostText = 'var(--alf-info-ghost-text, #0dcaf0)',
  ...
  PrimaryBorder = 'var(--alf-primary-border, #0a58ca)',
  PrimaryBorderHover = 'var(--alf-primary-border-hover, #084298)',
  PrimaryBorderFocus = 'var(--alf-primary-border-focus, #084298)',
  PrimaryBorderDisabled = 'var(--alf-primary-border-disabled, #8a9db8)',
  PrimaryBorderActive = 'var(--alf-primary-border-active, #084298)',
  ...
  SecondaryBorder = 'var(--alf-secondary-border, #5a6268)',
  SecondaryBorderHover = 'var(--alf-secondary-border-hover, #3d4246)',
  SecondaryBorderFocus = 'var(--alf-secondary-border-focus, #3d4246)',
  SecondaryBorderDisabled = 'var(--alf-secondary-border-disabled, #919a9f)',
  SecondaryBorderActive = 'var(--alf-secondary-border-active, #3d4246)',
  ...
  SuccessBorder = 'var(--alf-success-border, #146b43)',
  SuccessBorderHover = 'var(--alf-success-border-hover, #0e4a2e)',
  SuccessBorderFocus = 'var(--alf-success-border-focus, #0e4a2e)',
  SuccessBorderDisabled = 'var(--alf-success-border-disabled, #76a98e)',
  SuccessBorderActive = 'var(--alf-success-border-active, #0e4a2e)',
  ...
  DangerBorder = 'var(--alf-danger-border, #b92d3a)',
  DangerBorderHover = 'var(--alf-danger-border-hover, #9e2632)',
  DangerBorderFocus = 'var(--alf-danger-border-focus, #9e2632)',
  DangerBorderDisabled = 'var(--alf-danger-border-disabled, #d08990)',
  DangerBorderActive = 'var(--alf-danger-border-active, #9e2632)',
  ...
  WarningTextFocus = 'var(--alf-warning-text-focus, #ffffffff)',
  WarningTextDisabled = 'var(--alf-warning-text-disabled, #ffffffff)',
  WarningTextActive = 'var(--alf-warning-text-active, #ffffffff)',
  WarningTextHover = 'var(--alf-warning-text-hover, #ffffffff)',

  WarningBorder = 'var(--alf-warning-border, #d9a406)',
  WarningBorderHover = 'var(--alf-warning-border-hover, #b38600)',
  WarningBorderFocus = 'var(--alf-warning-border-focus, #b38600)',
  WarningBorderDisabled = 'var(--alf-warning-border-disabled, #d9cc9f)',
  WarningBorderActive = 'var(--alf-warning-border-active, #b38600)',
  ...
  InfoTextFocus = 'var(--alf-info-text-focus, #ffffffff)',
  InfoTextDisabled = 'var(--alf-info-text-disabled, #ffffffff)',
  InfoTextActive = 'var(--alf-info-text-active, #ffffffff)',
  InfoTextHover = 'var(--alf-info-text-hover, #ffffffff)',

  InfoBorder = 'var(--alf-info-border, #0babcc)',
  InfoBorderHover = 'var(--alf-info-border-hover, #0889a3)',
  InfoBorderFocus = 'var(--alf-info-border-focus, #0889a3)',
  InfoBorderDisabled = 'var(--alf-info-border-disabled, #86c9d6)',
  InfoBorderActive = 'var(--alf-info-border-active, #0889a3)',
  ...
  LightBorder = 'var(--alf-light-border, #ced4da)',
  LightBorderHover = 'var(--alf-light-border-hover, #adb5bd)',
  LightBorderFocus = 'var(--alf-light-border-focus, #86b7fe)',
  LightBorderDisabled = 'var(--alf-light-border-disabled, #e9ecef)',
  LightBorderActive = 'var(--alf-light-border-active, #adb5bd)',
  ...
  DarkBorder = 'var(--alf-dark-border, #191c1f)',
  DarkBorderHover = 'var(--alf-dark-border-hover, #14171a)',
  DarkBorderFocus = 'var(--alf-dark-border-focus, #14171a)',
  DarkBorderDisabled = 'var(--alf-dark-border-disabled, #777d82)',
  DarkBorderActive = 'var(--alf-dark-border-active, #14171a)',
  ...
  PrimaryOutlineBG = 'var(--alf-primary-outline-bg, #ffffff)',
  PrimaryOutlineFocusBG = 'var(--alf-primary-outline-focus-bg, #f4f8ff)',
  PrimaryOutlineDisabledBG = 'var(--alf-primary-outline-disabled-bg, #ffffff)',
  PrimaryOutlineActiveBG = 'var(--alf-primary-outline-active-bg, #f4f8ff)',
  PrimaryOutlineHoverBG = 'var(--alf-primary-outline-hover-bg, #f4f8ff)',
  ...
  SecondaryOutlineBG = 'var(--alf-secondary-outline-bg, #ffffff)',
  SecondaryOutlineFocusBG = 'var(--alf-secondary-outline-focus-bg, #f8f9fa)',
  SecondaryOutlineDisabledBG = 'var(--alf-secondary-outline-disabled-bg, #ffffff)',
  SecondaryOutlineActiveBG = 'var(--alf-secondary-outline-active-bg, #f8f9fa)',
  SecondaryOutlineHoverBG = 'var(--alf-secondary-outline-hover-bg, #f8f9fa)',
  ...
  SuccessOutlineBG = 'var(--alf-success-outline-bg, #ffffff)',
  SuccessOutlineFocusBG = 'var(--alf-success-outline-focus-bg, #f4faf7)',
  SuccessOutlineDisabledBG = 'var(--alf-success-outline-disabled-bg, #ffffff)',
  SuccessOutlineActiveBG = 'var(--alf-success-outline-active-bg, #f4faf7)',
  SuccessOutlineHoverBG = 'var(--alf-success-outline-hover-bg, #f4faf7)',
  ...
  DangerOutlineBG = 'var(--alf-danger-outline-bg, #ffffff)',
  DangerOutlineFocusBG = 'var(--alf-danger-outline-focus-bg, #fdf5f5)',
  DangerOutlineDisabledBG = 'var(--alf-danger-outline-disabled-bg, #ffffff)',
  DangerOutlineActiveBG = 'var(--alf-danger-outline-active-bg, #fdf5f5)',
  DangerOutlineHoverBG = 'var(--alf-danger-outline-hover-bg, #fdf5f5)',
  ...
  WarningOutlineBG = 'var(--alf-warning-outline-bg, #ffffff)',
  WarningOutlineFocusBG = 'var(--alf-warning-outline-focus-bg, #fffdf5)',
  WarningOutlineDisabledBG = 'var(--alf-warning-outline-disabled-bg, #ffffff)',
  WarningOutlineActiveBG = 'var(--alf-warning-outline-active-bg, #fffdf5)',
  WarningOutlineHoverBG = 'var(--alf-warning-outline-hover-bg, #fffdf5)',
  ...
  InfoOutlineBG = 'var(--alf-info-outline-bg, #ffffff)',
  InfoOutlineFocusBG = 'var(--alf-info-outline-focus-bg, #f4fdfd)',
  InfoOutlineDisabledBG = 'var(--alf-info-outline-disabled-bg, #ffffff)',
  InfoOutlineActiveBG = 'var(--alf-info-outline-active-bg, #f4fdfd)',
  InfoOutlineHoverBG = 'var(--alf-info-outline-hover-bg, #f4fdfd)',
  ...
  LightOutlineBG = 'var(--alf-light-outline-bg, #ffffff)',
  LightOutlineFocusBG = 'var(--alf-light-outline-focus-bg, #f8f9fa)',
  LightOutlineDisabledBG = 'var(--alf-light-outline-disabled-bg, #ffffff)',
  LightOutlineActiveBG = 'var(--alf-light-outline-active-bg, #f8f9fa)',
  LightOutlineHoverBG = 'var(--alf-light-outline-hover-bg, #f8f9fa)',
  ...
  DarkOutlineBG = 'var(--alf-dark-outline-bg, #ffffff)',
  DarkOutlineFocusBG = 'var(--alf-dark-outline-focus-bg, #f8f9fa)',
  DarkOutlineDisabledBG = 'var(--alf-dark-outline-disabled-bg, #ffffff)',
  DarkOutlineActiveBG = 'var(--alf-dark-outline-active-bg, #f8f9fa)',
  DarkOutlineHoverBG = 'var(--alf-dark-outline-hover-bg, #f8f9fa)',
  ...
  Warning3DText = 'var(--alf-warning-3d-text, #ffffffff)',
  Warning3DTextFocus = 'var(--alf-warning-3d-text-focus, #ffffffff)',
  Warning3DTextDisabled = 'var(--alf-warning-3d-text-disabled, #ffffffff)',
  Warning3DTextActive = 'var(--alf-warning-3d-text-active, #ffffffff)',
  ...
  Info3DText = 'var(--alf-info-3d-text, #ffffffff)',
  Info3DTextFocus = 'var(--alf-info-3d-text-focus, #ffffffff)',
  Info3DTextDisabled = 'var(--alf-info-3d-text-disabled, #ffffffff)',
  Info3DTextActive = 'var(--alf-info-3d-text-active, #ffffffff)',
  ...
  GradientOceanFocus = 'var(--alf-gradient-ocean-focus, linear-gradient(135deg, #3d8deb 0%, #00d2de 100%))',
  ...
  GradientOceanActive = 'var(--alf-gradient-ocean-active, linear-gradient(135deg, #3d8deb 0%, #00d2de 100%))',
  GradientOceanHover = 'var(--alf-gradient-ocean-hover, linear-gradient(135deg, #3d8deb 0%, #00d2de 100%))',

  GradientOceanBG = 'var(--alf-gradient-ocean-bg, linear-gradient(135deg, #4facfe 0%, #00f2fe 100%))',
  GradientOceanFocusBG = 'var(--alf-gradient-ocean-focus-bg, linear-gradient(135deg, #3d8deb 0%, #00d2de 100%))',
  ...
  GradientOceanActiveBG = 'var(--alf-gradient-ocean-active-bg, linear-gradient(135deg, #3d8deb 0%, #00d2de 100%))',
  GradientOceanHoverBG = 'var(--alf-gradient-ocean-hover-bg, linear-gradient(135deg, #3d8deb 0%, #00d2de 100%))',

  GradientOceanText = 'var(--alf-gradient-ocean-text, #ffffffff)',
  GradientOceanTextFocus = 'var(--alf-gradient-ocean-text-focus, #ffffffff)',
  GradientOceanTextDisabled = 'var(--alf-gradient-ocean-text-disabled, rgba(255, 255, 255, 0.6))',
  ...
  GradientOceanBorderHover = 'var(--alf-gradient-ocean-border-hover, #3d8deb)',
  GradientOceanBorderFocus = 'var(--alf-gradient-ocean-border-focus, #3d8deb)',
  GradientOceanBorderDisabled = 'var(--alf-gradient-ocean-border-disabled, rgba(79,172,254,0.5))',
  GradientOceanBorderActive = 'var(--alf-gradient-ocean-border-active, #3d8deb)',

  GradientForest = 'var(--alf-gradient-forest, linear-gradient(135deg, #11998e 0%, #38ef7d 100%))',
  GradientForestFocus = 'var(--alf-gradient-forest-focus, linear-gradient(135deg, #0e7f75 0%, #2ecc6b 100%))',
  ...
  GradientForestActive = 'var(--alf-gradient-forest-active, linear-gradient(135deg, #0e7f75 0%, #2ecc6b 100%))',
  GradientForestHover = 'var(--alf-gradient-forest-hover, linear-gradient(135deg, #0e7f75 0%, #2ecc6b 100%))',

  GradientForestBG = 'var(--alf-gradient-forest-bg, linear-gradient(135deg, #11998e 0%, #38ef7d 100%))',
  GradientForestFocusBG = 'var(--alf-gradient-forest-focus-bg, linear-gradient(135deg, #0e7f75 0%, #2ecc6b 100%))',
  ...
  GradientForestActiveBG = 'var(--alf-gradient-forest-active-bg, linear-gradient(135deg, #0e7f75 0%, #2ecc6b 100%))',
  GradientForestHoverBG = 'var(--alf-gradient-forest-hover-bg, linear-gradient(135deg, #0e7f75 0%, #2ecc6b 100%))',
  ...
  GradientForestTextDisabled = 'var(--alf-gradient-forest-text-disabled, rgba(255, 255, 255, 0.6))',
  ...
  GradientForestBorderHover = 'var(--alf-gradient-forest-border-hover, #0e7f75)',
  GradientForestBorderFocus = 'var(--alf-gradient-forest-border-focus, #0e7f75)',
  GradientForestBorderDisabled = 'var(--alf-gradient-forest-border-disabled, rgba(17,153,142,0.5))',
  GradientForestBorderActive = 'var(--alf-gradient-forest-border-active, #0e7f75)',
  ...
  GradientDangerFocus = 'var(--alf-gradient-danger-focus, linear-gradient(135deg, #dc2626 0%, #b91c1c 100%))',
  ...
  GradientDangerActive = 'var(--alf-gradient-danger-active, linear-gradient(135deg, #dc2626 0%, #b91c1c 100%))',
  GradientDangerHover = 'var(--alf-gradient-danger-hover, linear-gradient(135deg, #dc2626 0%, #b91c1c 100%))',

  GradientDangerBG = 'var(--alf-gradient-danger-bg, linear-gradient(135deg, #ef4444 0%, #dc2626 100%))',
  GradientDangerFocusBG = 'var(--alf-gradient-danger-focus-bg, linear-gradient(135deg, #dc2626 0%, #b91c1c 100%))',
  ...
  GradientDangerActiveBG = 'var(--alf-gradient-danger-active-bg, linear-gradient(135deg, #dc2626 0%, #b91c1c 100%))',
  GradientDangerHoverBG = 'var(--alf-gradient-danger-hover-bg, linear-gradient(135deg, #dc2626 0%, #b91c1c 100%))',
  ...
  GradientDangerTextDisabled = 'var(--alf-gradient-danger-text-disabled, rgba(255, 255, 255, 0.6))',
  ...
  GradientDangerBorderHover = 'var(--alf-gradient-danger-border-hover, #dc2626)',
  GradientDangerBorderFocus = 'var(--alf-gradient-danger-border-focus, #dc2626)',
  GradientDangerBorderDisabled = 'var(--alf-gradient-danger-border-disabled, rgba(239,68,68,0.5))',
  GradientDangerBorderActive = 'var(--alf-gradient-danger-border-active, #dc2626)',

  GradientSuccess = 'var(--alf-gradient-success, linear-gradient(135deg, #10b981 0%, #059669 100%))',
  GradientSuccessFocus = 'var(--alf-gradient-success-focus, linear-gradient(135deg, #059669 0%, #047857 100%))',
  ...
  GradientSuccessActive = 'var(--alf-gradient-success-active, linear-gradient(135deg, #059669 0%, #047857 100%))',
  GradientSuccessHover = 'var(--alf-gradient-success-hover, linear-gradient(135deg, #059669 0%, #047857 100%))',

  GradientSuccessBG = 'var(--alf-gradient-success-bg, linear-gradient(135deg, #10b981 0%, #059669 100%))',
  GradientSuccessFocusBG = 'var(--alf-gradient-success-focus-bg, linear-gradient(135deg, #059669 0%, #047857 100%))',
  ...
  GradientSuccessActiveBG = 'var(--alf-gradient-success-active-bg, linear-gradient(135deg, #059669 0%, #047857 100%))',
  GradientSuccessHoverBG = 'var(--alf-gradient-success-hover-bg, linear-gradient(135deg, #059669 0%, #047857 100%))',
  ...
  GradientSuccessTextDisabled = 'var(--alf-gradient-success-text-disabled, rgba(255, 255, 255, 0.6))',
  ...
  GradientSuccessBorderHover = 'var(--alf-gradient-success-border-hover, #059669)',
  GradientSuccessBorderFocus = 'var(--alf-gradient-success-border-focus, #059669)',
  GradientSuccessBorderDisabled = 'var(--alf-gradient-success-border-disabled, rgba(16,185,129,0.5))',
  GradientSuccessBorderActive = 'var(--alf-gradient-success-border-active, #059669)',

  GradientWarning = 'var(--alf-gradient-warning, linear-gradient(135deg, #f59e0b 0%, #d97706 100%))',
  GradientWarningFocus = 'var(--alf-gradient-warning-focus, linear-gradient(135deg, #d97706 0%, #b45309 100%))',
  ...
  GradientWarningActive = 'var(--alf-gradient-warning-active, linear-gradient(135deg, #d97706 0%, #b45309 100%))',
  GradientWarningHover = 'var(--alf-gradient-warning-hover, linear-gradient(135deg, #d97706 0%, #b45309 100%))',

  GradientWarningBG = 'var(--alf-gradient-warning-bg, linear-gradient(135deg, #f59e0b 0%, #d97706 100%))',
  GradientWarningFocusBG = 'var(--alf-gradient-warning-focus-bg, linear-gradient(135deg, #d97706 0%, #b45309 100%))',
  ...
  GradientWarningActiveBG = 'var(--alf-gradient-warning-active-bg, linear-gradient(135deg, #d97706 0%, #b45309 100%))',
  GradientWarningHoverBG = 'var(--alf-gradient-warning-hover-bg, linear-gradient(135deg, #d97706 0%, #b45309 100%))',

  GradientWarningText = 'var(--alf-gradient-warning-text, #ffffffff)',
  GradientWarningTextFocus = 'var(--alf-gradient-warning-text-focus, #ffffffff)',
  GradientWarningTextDisabled = 'var(--alf-gradient-warning-text-disabled, rgba(255, 255, 255, 0.6))',
  GradientWarningTextActive = 'var(--alf-gradient-warning-text-active, #ffffffff)',
  GradientWarningTextHover = 'var(--alf-gradient-warning-text-hover, #d1d1d1ff)',

  GradientWarningBorder = 'var(--alf-gradient-warning-border, #f59e0b)',
  GradientWarningBorderHover = 'var(--alf-gradient-warning-border-hover, #d97706)',
  GradientWarningBorderFocus = 'var(--alf-gradient-warning-border-focus, #d97706)',
  GradientWarningBorderDisabled = 'var(--alf-gradient-warning-border-disabled, rgba(245,158,11,0.5))',
  GradientWarningBorderActive = 'var(--alf-gradient-warning-border-active, #d97706)',
  ...
  GradientInfoTextDisabled = 'var(--alf-gradient-info-text-disabled, rgba(255, 255, 255, 0.6))',
  ...
  GradientInfoBorderDisabled = 'var(--alf-gradient-info-border-disabled, rgba(39,217,250,0.5))',
