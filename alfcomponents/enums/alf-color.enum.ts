...
export enum AlfColorEnum {
  ...
  PrimaryGhostDisabled = 'var(--alf-primary-ghost-disabled, rgba(13, 110, 253, 0.2))',
  ...
  SecondaryGhostDisabled = 'var(--alf-secondary-ghost-disabled, rgba(108, 117, 125, 0.2))',
  ...
  SuccessGhostDisabled = 'var(--alf-success-ghost-disabled, rgba(25, 135, 84, 0.2))',
  ...
  DangerGhostDisabled = 'var(--alf-danger-ghost-disabled, rgba(220, 53, 69, 0.2))',
  ...
  WarningGhostDisabled = 'var(--alf-warning-ghost-disabled, rgba(255, 193, 7, 0.2))',
  ...
  InfoGhostDisabled = 'var(--alf-info-ghost-disabled, rgba(13, 202, 240, 0.2))',
  ...
  LightGhostDisabled = 'var(--alf-light-ghost-disabled, rgba(233, 236, 239, 0.4))',
  ...
  DarkGhostDisabled = 'var(--alf-dark-ghost-disabled, rgba(33, 37, 41, 0.2))',
  ...
  GradientPrimary = 'var(--alf-gradient-primary, linear-gradient(135deg, #DD0031 0%, #C3002F 100%))',
  GradientPrimaryHover = 'var(--alf-gradient-primary-hover, linear-gradient(135deg, #DD0031 0%, #C3002F 100%))',
  ...
  GradientPrimaryDisabled = 'var(--alf-gradient-primary-disabled, linear-gradient(135deg, rgba(221,0,49,0.5) 0%, rgba(195,0,47,0.5) 100%))',
  ...
  GradientInfo = 'var(--alf-gradient-info, linear-gradient(135deg, #3b82f6 0%, #2563eb 100%))',
  GradientInfoHover = 'var(--alf-gradient-info-hover, linear-gradient(135deg, #3b82f6 0%, #2563eb 100%))',
